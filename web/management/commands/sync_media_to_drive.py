...
class Command(BaseCommand):
    help = 'Synchronizuje katalog media z Google Drive, dodając lub aktualizując pliki na podstawie nazwy i rozmiaru'
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            # Rekurencyjne mapowanie struktury plików i folderów na Google Drive
            ...
            self.sync_folder(service, folder_path, drive_media_folder_id, drive_files_map)
    ...
    def sync_folder(self, service, local_folder_path, parent_id, drive_files_map):
        """Rekursywnie synchronizuje lokalny folder z Google Drive."""
        for root, dirs, files in os.walk(local_folder_path):
            ...
            for file_name in files:
                ...
                # Sprawdzenie, czy plik już istnieje w bieżącym podfolderze i czy ma ten sam rozmiar
                if file_name in current_map and current_map[file_name]['type'] == 'file':
                    ...
                    if file_size == drive_file['size']:
                        ...
                        self.update_file(service, file_path, drive_file['id'])
                else:
